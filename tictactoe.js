const tictactoe = (function() {
  ...
  function checkWinner() {
    ...
    if (winner !== null) {
      playing = false;
      infoElement.innerHTML = winner + ' WINS<br><button class="restart-btn" onclick="tictactoe.restart()">RESTART</button>';
    } else if ( // check draw
      ...
      playing = false;
      infoElement.innerHTML = 'DRAW<br><button class="restart-btn" onclick="tictactoe.restart()">RESTART</button>';
    }
  }
